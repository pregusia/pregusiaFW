...
class HTTPRequestFile {
	...
	public function getPath() { return $this->arr['tmp_name']; }
	public function getSize() { return $this->arr['size']; }
	...
	public function getBinaryData() {
		return new BinaryData($this->getContent());
	}
	...
	public static function Create($arr) {
		if (is_uploaded_file($arr['tmp_name'])) {
			return new HTTPRequestFile($arr);
		} else {
			return null;
		}
	}
