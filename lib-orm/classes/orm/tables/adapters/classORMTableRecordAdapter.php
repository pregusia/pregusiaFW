...
abstract class ORMTableRecordAdapter {
	 ...
	 * @return SQLStorage
	 */
	public function getSQLStorage() { return $this->getRecord()->getSQLStorage(); }
	
	//************************************************************************************
	/**
	 * @return ORM
	 */
	public function getORM() { return $this->getRecord()->getORM(); }
