...
<div id="{$Widget['elementID']}_main" class="form-group ui-widget-ColorInput ui-widget-name-{$Widget['name']} {$Widget['Errors'] ? 'has-error' : ''}">
	...
	<div class="col-md-9">
		...
		<div class="input-group">
			...
			<input id="{$Widget['elementID']}" {$Widget['elementParams']} class="form-control {$Widget['elementClasses']}" type="color" name="{$Widget['name']}" tabindex="{$Widget['index']}" value="{$Widget['value:html']}" />
