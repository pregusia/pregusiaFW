...
class SourceCodeTextWidgetWebUIExtension implements IWebUIExtension {
	...
	public function prepareAssets($oAssets) {
		$oAssets->addJSLocation('lib-sourcecode-widget:js/ace.min.js');
		$oAssets->addJSLocation('lib-sourcecode-widget:js/ace.config.js');
		$oAssets->addJSLocation('lib-sourcecode-widget:js/ui.js');
	}	
