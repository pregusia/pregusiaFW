 ...
 *
 */
class UIWidget_TimeInput extends UIWidgetWithValue {
	...
	public function setValueString($str) {
		$this->value = Time::FromString($str);
	}
	...
	protected function onRead($oRequest) {
		$this->value = Time::FromString($oRequest->getString($this->getName()));
	}
	
	//************************************************************************************
	public function uiRenderGetTemplateLocation($ctx=null) {
		return 'lib-datetime:UIWidget.TimeInput';
	}
